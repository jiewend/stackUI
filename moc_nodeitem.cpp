...
QT_MOC_LITERAL(1, 9, 20), // "sendshowchatwindowID"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13), // "StatusOffline"
QT_MOC_LITERAL(4, 45, 12) // "StatusOnline"

    },
    "NodeItem\0sendshowchatwindowID\0\0"
    "StatusOffline\0StatusOnline"
};
...
void NodeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendshowchatwindowID((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->StatusOffline((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->StatusOnline((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (NodeItem::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeItem::sendshowchatwindowID)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NodeItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NodeItem.data,
...
// SIGNAL 0
void NodeItem::sendshowchatwindowID(int _t1)
{
